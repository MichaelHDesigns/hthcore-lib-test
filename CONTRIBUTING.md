...
These are some global design goals in hthcore-lib that any change must adhere.
...
When possible, hthcore-lib objects should have standard methods on an instance prototype:
...
`JSON.stringify` and `JSON.parse` are expected to be handled outside of the scope of hthcore-lib methods. For example, calling `JSON.stringify` on an hthcore-lib object will behave as expected and call `transaction.toJSON()` and then stringify it:
...
```sh
git remote add dashevo git@github.com:dashevo/hthcore-lib.git
...
Finally go to [github.com/dashevo/hthcore-lib](https://github.com/dashevo/hthcore-lib) in your web browser and issue a new pull request.

Main contributors will review your code and possibly ask for changes before your code is pulled in to the main repository. We'll check that all tests pass, review the coding style, and check for general code correctness. If everything is OK, we'll merge your pull request and your code will be part of hthcore-lib.

If you have any questions feel free to post them to
[github.com/dashevo/hthcore-lib/issues](https://github.com/dashevo/hthcore-lib/issues).
